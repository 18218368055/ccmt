/*
 * 在原有pagination.js基础上扩展了一些东西
 * 参数：
 * totalNumberLocator  同locator一样的语法，可用于动态获取数据总数量
 */
...
//        var postData = {};
        var postData = attributes.data ? attributes.data() : {};
      ...
      filterDataByLocator: function(dataSource) {
        ...
        //自定义取总数量
        if (attributes.totalNumberLocator) {
        	var totalNumberLocator = this.getLocator(attributes.totalNumberLocator);
